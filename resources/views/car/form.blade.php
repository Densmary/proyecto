<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            {{ Form::label('Marca') }}
            {{ Form::text('brand', $car->brand, ['class' => 'form-control' . ($errors->has('brand') ? ' is-invalid' : ''), 'placeholder' => '']) }}
        ...
        <div class="form-group">
            {{ Form::label('Tipo de transmición') }}
